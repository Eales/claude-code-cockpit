...
`resets_at` i budził sesję co 15 min bez końca (`~/.claude/cockpit-resume.log`, pięć
przebudzeń w ciągu trzech godzin). Stąd zasada, że hook budzi sesję **wyłącznie** wtedy,
gdy zna konkretny czas resetu, a w każdym innym przypadku kończy się natychmiast.
